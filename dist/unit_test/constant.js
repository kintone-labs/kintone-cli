...
exports.PRIVATE_KEY = exports.PROJECT_TYPE = exports.WEBPACK_CONTENT = exports.DIR_BUILD_PATH = exports.OPTIONS_DEPLOY = exports.OPTIONS_BUILD = exports.APP_NAME = void 0;
const path_1 = __importDefault(require("path"));
exports.APP_NAME = 'test-app';
exports.OPTIONS_BUILD = ['node', 'build', '--app-name', exports.APP_NAME];
exports.OPTIONS_DEPLOY = ['node', 'deploy', '--app-name', exports.APP_NAME];
