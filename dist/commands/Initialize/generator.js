...
const generateAppFolder = (option) => {
    ...
    if (option.setAuth) {
        ...
        (0, jsonfile_1.writeFileSync)(`${option.appName}/auth.json`, authJSON, {
            spaces: 4,
            EOL: '\r\n'
        });
    }
    ...
    if (option.useWebpack) {
        ...
        (0, jsonfile_1.writeFileSync)(`${option.appName}/.babelrc`, babelJSON, {
            spaces: 4,
            EOL: '\r\n'
        });
    ...
    if (option.useTypescript) {
        ...
        (0, jsonfile_1.writeFileSync)(`${option.appName}/tsconfig.json`, tsConfigJSON, {
            spaces: 4,
            EOL: '\r\n'
        });
        if (!option.useWebpack)
    ...
    if (option.useCybozuLint) {
        ...
        const eslintRcTemplete = (0, eslintRcTemplate_1.buildEslintRcTemplate)(option);
    ...
    (0, jsonfile_1.writeFileSync)(`${option.appName}/config.json`, manifestJSON, {
        spaces: 4,
        EOL: '\r\n'
    });
    if (option.entry) {
