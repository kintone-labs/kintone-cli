...
(0, globals_1.describe)('Deploy Command', () => {
    (0, globals_1.describe)('Domain', () => {
        (0, globals_1.test)('Should be set as "https://domain.kintone.com" when setting the domain to "https://domain.kintone.com"', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const config = (0, jsonfile_1.readFileSync)(`${currentDir}/auth.json`);
            (0, globals_1.expect)(config.domain).toBe('https://domain.kintone.com');
        }));
    });
});
